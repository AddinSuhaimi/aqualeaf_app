...
class ScanSeaweedFresh extends StatefulWidget {
  const ScanSeaweedFresh({super.key});

  @override
  State<ScanSeaweedFresh> createState() => _ScanSeaweedFreshState();
}

class _ScanSeaweedFreshState extends SeaweedScannerBaseState<ScanSeaweedFresh> {
  @override
